 ...
 $id_user;
 $connected = $this->session->userdata('formateur_login');
 $email_ok;
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="<?php echo(base_url()) ?>formateur/notification">Voir toutes les notifications</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?php echo(base_url())?>formateur/profile">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <a class="dropdown-item" href="<?php echo(base_url())?>formateur/basic">
                                    <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Paramètre
                                </a>
                                <a class="dropdown-item" href="<?php echo(base_url())?>formateur/notification">
