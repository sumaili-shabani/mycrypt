          ...
          <div class="post-item small col-md-12 mt-2">
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-3">
                <div class="img-thumb">
                  <a href="<?php echo(base_url())?>formateur/blog/<?php echo($key['idart'])?>">
              ...
              <div class="col-sm-8 col-xs-9 no-padding-left">
                <div class="post-content">
                  <a href="<?php echo(base_url())?>formateur/blog/<?php echo($key['idart'])?>"><h6> <?php echo (substr($key['nom'], 0,50)); ?> ...</h6></a>
