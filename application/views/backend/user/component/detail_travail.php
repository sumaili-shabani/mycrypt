                 ...
                 <?php 
					...
					if ($today <= $limite) {
						...
						<div class="col-md-12 alert alert-success mb-1">
							<i class="fa fa-clock-o mr-1"></i> <span class="text-success"> Fin de dépôt:</span> <span class="text-danger"><?php echo(nl2br(substr(date(DATE_RFC822, strtotime($limite)), 0, 23))) ?></span>
						</div>
						...
						?>
						 <!-- Icon Block -->
						 <div class="col-md-12 alert alert-danger mb-1">
							<i class="fa fa-clock-o mr-1"></i> <span class="text-success"> Fin de dépôt:</span> <span class="text-danger"><?php echo(nl2br(substr(date(DATE_RFC822, strtotime($limite)), 0, 23))) ?></span>
						</div>
		                <div class="media text-body font-size-1 mb-2">
		                  <div class="min-w-3rem text-center mr-3">
