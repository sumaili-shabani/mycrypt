    ...
    <script type="text/javascript">
      $(document).ready(function() {
          ...
          */
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_cours/",
             method:"GET",
              beforeSend:function()
              {
         ...
         {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/fetch_search_view_cours",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
         ...
         $(document).on('change', '#limit', function(event) {
              ...
              if (limit !='') {
                $.ajax({
                  url: '<?php echo base_url(); ?>admin/fetch_limit_view_module',
                  type: 'POST',
                  data: {limit: limit},
                  beforeSend:function()
                  {
