...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim 26 sep. 2021 à 10:21
...
(5, 14, 12, '2021-09-25 18:37:12', 'Edition1');
...
(11, 'Configuration d\'environnement myql', 12, 7, '.2.1.3 Préparation de l\'environnement MySQL de Windows\r\nSi vous devez spécifier les options de démarrage lors du lancement de votre serveur, vous pouvez les indiquer en ligne de commande ou bien les placer dans un fichier d\'options. Pour les options qui seront utilisées à chaque démarrage, il est plus pratique de les mettre dans le fichier de configuration MySQL. C\'est particulièrement vrai dans les circonstances suivantes :\r\n\r\nLe répertoire d\'installation ou de données est différent de ceux par défaut ( c:\\mysql et c:\\mysql\\data ).\r\nVous devez paraméter la configuration du serveur. Par exemple, pour utiliser les tables transactionnelles InnoDB en MySQL version 3.23, vous devez manuellement créer deux nouveaux dossiers pour stocker les données InnoDB , données et log : C:\\ibdata and C:\\iblogs . Vous devez aussi ajouter des lignes de configurations supplémentaires dans le fichier d\'options, comme décrit dans la section Options de démarrage InnoDB . Depuis MySQL 4.0, InnoDB crée un fichier de données et un fichier de log dans le dossier de données par défaut. Cela signifie que vous n\'avez plus besoin de configurer explicitement InnoDB. Vous pouvez toujours le faire si vous le souhaitez, et un fichier d\'options sera alors utile.', '199645746', '1507209266.mp4', '2021-09-25 18:44:36');
...
(118, 'John smith vient d\'ajouter un travail\r\n		             cool à la formation programmation fonctionnel pro-moderne', 'user/work/10/160505209', 12, '2021-09-23 20:53:20', 'fa fa-bookmark-o', 'Vous avez peut être raté travail: cool'),
...
(126, 'mikah kalume vient de payer 20$', 'admin/paiement_normale', 8, '2021-09-25 18:31:49', 'fa fa-bell', 'nouveau paiement'),
(127, 'jérémie  vous venez d\'être attribué à la formationAnglais parlé', 'formateur/myformation/12/14', 14, '2021-09-25 18:37:12', 'fa fa-headphones', 'Coach mentor pour la foration Anglais parlé'),
(128, 'sumaili shabani vient d\'ajouter un cours\r\n		             Base de données MySQL à la formation programmation fonctionnel pro-moderne', 'user/cours/11/847170148', 11, '2021-09-25 18:41:44', 'fa fa-book', 'nouveau cours: Base de données MySQL'),
(129, 'sumaili shabani vient d\'ajouter un cours\r\n		             Base de données MySQL à la formation programmation fonctionnel pro-moderne', 'user/cours/11/847170148', 12, '2021-09-25 18:41:44', 'fa fa-book', 'nouveau cours: Base de données MySQL'),
(130, 'sumaili shabani vient d\'ajouter une leçon\r\n		             Configuration d\'environnement myql à la formation programmation fonctionnel pro-moderne', 'user/lesson/12/199645746', 11, '2021-09-25 18:44:36', 'fa fa-video', 'nouvelle leçon: Configuration d\'environnement myql'),
(131, 'sumaili shabani vient d\'ajouter une leçon\r\n		             Configuration d\'environnement myql à la formation programmation fonctionnel pro-moderne', 'user/lesson/12/199645746', 12, '2021-09-25 18:44:36', 'fa fa-video', 'nouvelle leçon: Configuration d\'environnement myql'),
(132, 'sumaili shabani vient d\'ajouter un travail\r\n		             TP n1 à la formation programmation fonctionnel pro-moderne', 'user/work/11/1099208226', 11, '2021-09-25 18:48:07', 'fa fa-bookmark-o', 'Vous avez peut être raté travail: TP n1'),
(133, 'sumaili shabani vient d\'ajouter un travail\r\n		             TP n1 à la formation programmation fonctionnel pro-moderne', 'user/work/11/1099208226', 12, '2021-09-25 18:48:07', 'fa fa-bookmark-o', 'Vous avez peut être raté travail: TP n1'),
(134, 'sumaili shabani vient d\'ajouter un cours\r\n		             Javascript ES6 à la formation Anglais parlé', 'user/cours/12/582381131', 12, '2021-09-26 07:57:36', 'fa fa-book', 'nouveau cours: Javascript ES6'),
(135, 'sumaili shabani vient d\'ajouter un cours\r\n		             Javascript ES6 à la formation Anglais parlé', 'user/cours/12/582381131', 13, '2021-09-26 07:57:36', 'fa fa-book', 'nouveau cours: Javascript ES6'),
(136, 'sumaili shabani vient d\'ajouter un cours\r\n		             Cours Javascript ES6  à la formation programmation fonctionnel pro-moderne', 'user/cours/11/2072105420', 11, '2021-09-26 08:05:15', 'fa fa-book', 'nouveau cours: Cours Javascript ES6 '),
(137, 'sumaili shabani vient d\'ajouter un cours\r\n		             Cours Javascript ES6  à la formation programmation fonctionnel pro-moderne', 'user/cours/11/2072105420', 12, '2021-09-26 08:05:15', 'fa fa-book', 'nouveau cours: Cours Javascript ES6 '),
(138, 'John smith vient d\'ajouter un cours\r\n		             Introduction aux Hooks à la formation programmation fonctionnel pro-moderne', 'user/cours/11/523945725', 11, '2021-09-26 08:18:18', 'fa fa-book', 'nouveau cours: Introduction aux Hooks'),
(139, 'John smith vient d\'ajouter un cours\r\n		             Introduction aux Hooks à la formation programmation fonctionnel pro-moderne', 'user/cours/11/523945725', 12, '2021-09-26 08:18:18', 'fa fa-book', 'nouveau cours: Introduction aux Hooks');
...
(14, 13, '2021-09-16', 20, 'Paiement formation', '31249d717004bcf0264ace5df8551ef9', '2021-09-15 23:08:21', '8038da89e49ac5eabb489cfc6cea9fc1', 1),
...
(17, 13, '2021-09-25', 20, 'paiement frais d\'inscription pour la formation', '4ee7b63ba59a3d5e3a8bdce963f234c0', '2021-09-25 18:31:49', '8038da89e49ac5eabb489cfc6cea9fc1', 1);
...
(9, 'TP n1', 11, 7, 'Sous Windows, l\'installeur MySQL place le dossier de données dans le dossier d\'installation de MySQL. Si vous souhaitez utiliser un autre dossier de données, dans une autre partie du disque, vous devez copier le contenu du dossier data dans le nouveau dossier. Par exemple, par défaut, l\'installeur MySQL place les fichiers MySQL dans le dossier C:\\mysql et le dossier de données dans le dossier C:\\mysql\\data . Si vous voulez utiliser le dossier de données E:\\mydata , vous devez faire deux choses :\r\nDéplacer le dossier de données de C:\\mysql\\data à E:\\mydata .\r\nUtiliser l\'option de démarrage --datadir pour spécifier le nouveau dossier de données, à chaque fois que vous voulez lancer le serveur.\r\nLorsque le serveur MySQL démarre sur Windows, il recherche les options dans deux fichiers : my.ini dans le dossier Windows, et le fichier C:\\my.cnf . Le dossier Windows est généralement C:\\WINDOWS ou C:\\WinNT . Vous pouvez déterminer sa localisation exacte à partir de la valeur de la variable d\'environnement WINDIR :\r\n\r\nC:\\&gt; echo %WINDIR%\r\nMySQL recherche les options d\'abord dans le fichier my.ini , puis dans le fichier my.cnf . Cependant, pour éviter les confusions, il est bon de n\'utiliser qu\'un seul des deux fichiers. Si votre PC utilise un fichier de boot où le lecteur C: n\'est pas le disque de boot, votre seule option est d\'utiliser le fichier my.ini . Quelque soit celui que vous utilisez, ce doit être un fichier de texte.Un fichier d\'options peut être créé simplement et modifié avec un editeur de texte quelconque, comme Notepad . Par exemple, si MySQL est installé dans le dossier D:\\mysql et que le dossier de données est situé dans D:\\mydata\\data , vous pouvez créer un fichier d\'options et configurer une section [mysqld] pour spécifier les valeurs de basedir et datadir :\r\n', '1099208226', '2021-09-25 18:48:07', '2021-09-25', '19:48:00');
...
--
ALTER TABLE `coach`
  MODIFY `idcoach` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `cours`
  MODIFY `idcours` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `lesson`
  MODIFY `idlesson` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `travail`
  MODIFY `idtravail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
